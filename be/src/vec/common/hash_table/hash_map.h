...
public:
    ...
    void build(const Key* __restrict keys, const size_t* __restrict bucket_nums,
    ...
    template <int JoinOpType>
    auto find_batch(const Key* __restrict keys, const size_t* __restrict bucket_nums, int probe_idx,
