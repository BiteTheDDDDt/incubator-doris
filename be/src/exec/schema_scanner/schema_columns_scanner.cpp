...
SchemaScanner::ColumnDesc SchemaColumnsScanner::_s_col_columns[] = {
        ...
        {"ORDINAL_POSITION", PrimitiveType::TYPE_BIGINT, sizeof(int64_t), false},
        {"COLUMN_DEFAULT", PrimitiveType::TYPE_VARCHAR, sizeof(StringValue), true},
        {"IS_NULLABLE", PrimitiveType::TYPE_VARCHAR, sizeof(StringValue), false},
        {"DATA_TYPE", PrimitiveType::TYPE_VARCHAR, sizeof(StringValue), false},
        {"CHARACTER_MAXIMUM_LENGTH", PrimitiveType::TYPE_BIGINT, sizeof(int64_t), true},
        {"CHARACTER_OCTET_LENGTH", PrimitiveType::TYPE_BIGINT, sizeof(int64_t), true},
        {"NUMERIC_PRECISION", PrimitiveType::TYPE_BIGINT, sizeof(int64_t), true},
        {"NUMERIC_SCALE", PrimitiveType::TYPE_BIGINT, sizeof(int64_t), true},
        {"DATETIME_PRECISION", PrimitiveType::TYPE_BIGINT, sizeof(int64_t), true},
        {"CHARACTER_SET_NAME", PrimitiveType::TYPE_VARCHAR, sizeof(StringValue), true},
        {"COLLATION_NAME", PrimitiveType::TYPE_VARCHAR, sizeof(StringValue), true},
        {"COLUMN_TYPE", PrimitiveType::TYPE_VARCHAR, sizeof(StringValue), false},
        {"COLUMN_KEY", PrimitiveType::TYPE_VARCHAR, sizeof(StringValue), false},
        {"EXTRA", PrimitiveType::TYPE_VARCHAR, sizeof(StringValue), false},
        {"PRIVILEGES", PrimitiveType::TYPE_VARCHAR, sizeof(StringValue), false},
        {"COLUMN_COMMENT", PrimitiveType::TYPE_VARCHAR, sizeof(StringValue), false},
        {"COLUMN_SIZE", PrimitiveType::TYPE_BIGINT, sizeof(int64_t), true},
        {"DECIMAL_DIGITS", PrimitiveType::TYPE_BIGINT, sizeof(int64_t), true},
        {"GENERATION_EXPRESSION", PrimitiveType::TYPE_VARCHAR, sizeof(StringValue), true},
        {"SRS_ID", PrimitiveType::TYPE_BIGINT, sizeof(int64_t), true},
};
