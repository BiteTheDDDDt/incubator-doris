...
SchemaScanner::ColumnDesc SchemaTablesScanner::_s_tbls_columns[] = {
        ...
        {"TABLE_TYPE", PrimitiveType::TYPE_VARCHAR, sizeof(StringValue), false},
        {"ENGINE", PrimitiveType::TYPE_VARCHAR, sizeof(StringValue), true},
        ...
        {"AUTO_INCREMENT", PrimitiveType::TYPE_BIGINT, sizeof(int64_t), true},
        {"CREATE_TIME", PrimitiveType::TYPE_DATETIME, sizeof(DateTimeValue), true},
        ...
        {"TABLE_COLLATION", PrimitiveType::TYPE_VARCHAR, sizeof(StringValue), true},
        {"CHECKSUM", PrimitiveType::TYPE_BIGINT, sizeof(int64_t), true},
        {"CREATE_OPTIONS", PrimitiveType::TYPE_VARCHAR, sizeof(StringValue), true},
        {"TABLE_COMMENT", PrimitiveType::TYPE_VARCHAR, sizeof(StringValue), false},
};
