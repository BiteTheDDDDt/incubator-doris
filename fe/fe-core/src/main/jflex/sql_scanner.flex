...
%{
    ...
    static {
        ...
        keywordMap.put("bitand", new Integer(SqlParserSymbols.KW_BITAND));
        keywordMap.put("bitor", new Integer(SqlParserSymbols.KW_BITOR));
        keywordMap.put("bitxor", new Integer(SqlParserSymbols.KW_BITXOR));
        keywordMap.put("bitnot", new Integer(SqlParserSymbols.KW_BITNOT));
        ...
        keywordMap.put("divide", new Integer(SqlParserSymbols.KW_DIVIDE));
        ...
        keywordMap.put("mod", new Integer(SqlParserSymbols.KW_MOD));
        keywordMap.put("multiply", new Integer(SqlParserSymbols.KW_MULTIPLY));
        ...
        keywordMap.put("subtract", new Integer(SqlParserSymbols.KW_SUBTRACT));
